...
exports.initiate = async (req, res) => {
  ...
  try {
    await client.query('BEGIN');
    const { employee_id, type, reason, notice_date, last_working_date, personal_email, contact_number } = req.body;
    if (!employee_id || !type)
