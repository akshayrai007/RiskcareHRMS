...
const PROVISION_APPROVERS = ['hr','admin','super_admin','manager','tl','accounts'];
...
router.post('/leave/import/requests',        authenticate, authorize(...HR_ADMIN), lvImportCtrl.uploadMiddleware, lvImportCtrl.importLeaveRequests);
...
router.get   ('/it-declaration/export-zip',         authenticate, authorize('hr','accounts'),  itDeclCtrl.exportZip);
...
router.get   ('/it-declaration/dashboard',          authenticate, authorize('hr','accounts'),  itDeclCtrl.getDashboard);
...
router.get   ('/it-declaration/:id/download-zip',   authenticate, authorize('hr','accounts'),  itDeclCtrl.downloadDeclZip);
router.get   ('/it-declaration/:id',                authenticate, authorize('hr','accounts'),  itDeclCtrl.getDeclarationById);
