  ...
  try {
    ...
    setTimeout(async () => {
      try {
        ...
        // ── One-time monthly payroll adjustments (entered in the monthly payroll
        ...
        // Full salary-structure snapshot (every component incl. PF/EPS/ESI etc.) at the time of each revision
        await db.query(`ALTER TABLE employee_salary_history ADD COLUMN IF NOT EXISTS structure_snapshot JSONB`);
